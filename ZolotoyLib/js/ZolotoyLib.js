...
(function (ZolotoyLib) {
  ...
  (function (Dompp) {
    ...
    (function (Inputs) {
      ...
      function getInputBoolean(theme = "White") {
        ...
        html.innerHTML = `<option selected disabled>Выберете "Да" или "Нет"</option> 
              ...
              Dompp.createHTMLElement(
                ...
                [
                  Dompp.createHTMLElement(
                    ...
                    Dompp.Themes[theme]["input-object"]["input-object-key"]
                  ),
                  Dompp.createHTMLElement(
                    "div",
                    {},
                    ...
                    Dompp.Themes[theme]["input-object"]["input-object-value"]
                  ),
                ],
                HTMLDivElement
              ).styled(
                Dompp.Themes[theme]["input-object"]["input-object-element"]
              )
            );
            return true;
          }, obj);
          return html.styled(
            Dompp.Themes[theme]["input-object"]["input-object-main"]
          );
        }
        return null;
      }
      ...
      function getInputStringObject(obj, theme = "White") {
        if (typeof obj === "object") {
          let html = Dompp.createHTMLElement(
            "div",
              ...
              Dompp.createHTMLElement(
                ...
                [
                  Dompp.createHTMLElement(
                    ...
                    Dompp.Themes[theme]["input-list"]["input-list-index"]
                  ),
                  Dompp.createHTMLElement(
                    "div",
                    ...
                    Dompp.Themes[theme]["input-list"]["input-list-value"]
                  ),
                ],
                HTMLDivElement
              ).styled(Dompp.Themes[theme]["input-list"]["input-list-element"])
            );
            return true;
          }, arr);
        }
        return Dompp.createHTMLElement(
          "div",
          { classes: ["more-input-list"] },
          elements,
          HTMLDivElement
        ).styled(Dompp.Themes[theme]["input-list"]["input-list-main"]);
      }
    ...
    (function (DragAndDrop) {
      ...
      class DragAndDropElement {
        ...
        MouseOnHitbox() {
          ...
          return (
            box.x + this.options.hitbox.x < Dompp.Mouse.vector.x &&
        ...
        update() {
          this.html.onmousedown = (e) => {
            ...
            let mouseStart = new JSClasses.Vector2(
              Dompp.Mouse.vector.x - box.x,
              Dompp.Mouse.vector.y - box.y
            );
            this.mousemove = (e) => {
        ...
        moveAt(mouseStart, count = false) {
          ...
          if (
            ...
            Dompp.Mouse.click &&
            (!(
              box.x < this.options.minpos.x ||
              box.x + box.width > this.options.maxpos.x
            ) ||
              !(
                box.y < this.options.minpos.y ||
                box.y + box.height > this.options.maxpos.y
              ))
          ) {
  ...
  (function (CustomWindow) {
    ...
    class DOMWindow {
      ...
      set options(v) {
        this._options.dad =
          typeof v.dad === "boolean" ? v.dad : this._options.dad;
        this._options.height =
          typeof v.height === "number" ? v.height : this._options.height;
        this._options.width =
          typeof v.width === "number" ? v.width : this._options.width;
      }
      get title() {
        return this._title;
      }
      ...
      update() {
        ...
        this.html = Dompp.createHTMLElement(
          "div",
          {},
          [
            Dompp.createHTMLElement(
              ...
              [this.title],
              HTMLDivElement
            ).styled(CustomWindow.Themes[this.theme]["window-head"]),
            Dompp.createHTMLElement("div", {}, [this.content], HTMLDivElement)
              .styled(CustomWindow.Themes[this.theme]["window-body"])
              .styled({
                width: `${this.hitbox.width - 10}px`,
                height: `${this.hitbox.height - 40}px`,
              }),
          ],
          HTMLDivElement
        )
          .styled(CustomWindow.Themes[this.theme]["window"])
          .styled({
        ...
        this._dad = new Dompp.DragAndDrop.DragAndDropElement(
          ...
          this.options ? "full" : "none",
          {
            ...
            hitbox: this.options.dad
              ? new JSClasses.Rectangle(
                  10,
                  33,
                  this.hitbox.width - 10,
                  this.hitbox.height - 17
                )
              : new JSClasses.Rectangle(
                  0,
                  0,
